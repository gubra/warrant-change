...
import com.organic.model.WarrantClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"organic-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "organic-portlet";
			}
	...
	public static Object translateInputWarrant(BaseModel<?> oldModel) {
		...
		try {
			...
			try {
				Class<?> newModelClass = Class.forName("com.organic.model.impl.WarrantImpl",
						true, _classLoader);
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.organic.model.impl.WarrantImpl")) {
